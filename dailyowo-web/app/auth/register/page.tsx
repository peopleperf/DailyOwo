      ...
      <Container size="sm" className="py-8 relative">
        <motion.div {...fadeInUp} className="max-w-md mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl font-light text-primary mb-3">Create an Account</h1>
            <p className="text-primary/50 text-sm font-light">Start your journey to financial wellness.</p>
          </div>
          ...
          <GlassContainer className="p-10 bg-gradient-to-br from-white via-white to-gold/5" goldBorder>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs mt-2 pl-1">
                    <PasswordRequirement label="At least 8 characters" met={passwordValidation.minLength} />
                    <PasswordRequirement label="One uppercase letter" met={passwordValidation.uppercase} />
                    <PasswordRequirement label="One lowercase letter" met={passwordValidation.lowercase} />
                    <PasswordRequirement label="One number" met={passwordValidation.number} />
                  </div>
                </div>
              ...
              <div className="space-y-4 pt-4">
                ...
                >
                  {isLoading ? <Loader size="sm" variant="gold" /> : 'Create Account'}
                </GlassButton>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-4 bg-white text-primary/40 font-light">Or sign up with</span>
                  </div>
                </div>
