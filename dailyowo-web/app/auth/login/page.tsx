...
export default function LoginPage() {
  ...
  const { signIn, signInWithGoogle, error, user, userProfile, requires2FA, pendingUser, verify2FA } = useAuth();
  ...
  const handleBack2FA = () => {
    // Reset 2FA state and return to login form
      ...
      <Container size="sm" className="py-8 relative">
        <motion.div {...fadeInUp} className="max-w-md mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-primary/60 font-light">Enter your credentials to access your account.</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 pt-4">
                <GlassButton
                  ...
                  goldBorder
                  disabled={isLoading}
                  className="py-4 text-sm font-light tracking-wide min-h-[48px]"
                >
                  {isLoading ? <Loader size="sm" variant="gold" /> : 'Sign In'}
                </GlassButton>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-4 bg-white text-primary/40 font-light">Or continue with</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full glass px-4 py-3 rounded-xl flex items-center justify-center gap-3 hover:bg-white/60 transition-all text-primary/70 font-light disabled:opacity-50 min-h-[48px]"
                >
