    ...
    <div className="min-h-screen bg-white">
      ...
      <Container size="lg" className="py-8 md:py-12 pb-24">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="flex gap-8 border-b border-gray-100 overflow-x-auto pb-0 scrollbar-hide">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <button
                  ...
                  className={`
                    relative pb-4 px-1 font-light transition-all whitespace-nowrap flex items-center gap-2
